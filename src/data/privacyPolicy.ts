  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'İlan Radarı: kaydettiğin arama kriterleri (bölge, oda tipi, fiyat aralığı, tarih vb.) ve radarına uyan yeni ilanlar için gönderdiğimiz bildirimler. Yalnızca sana görünür; başka kullanıcılarla paylaşılmaz.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Hesabını sildiğinde profilin, telefon numaran, ilanların ve fotoğrafların, bildirimlerin, favorilerin, İlan Radarı aramaların ve senin yaptığın şikayetler hemen ve kalıcı olarak silinir.',
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'Listing Radar: the search criteria you save (area, room type, price range, dates, etc.) and the alerts we send when a new listing matches. They are visible only to you and never shared with other users.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'When you delete your account, your profile, phone number, listings and photos, notifications, favorites, Listing Radar searches and the reports you filed are deleted immediately and permanently.',
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'Radar annunci: i criteri di ricerca che salvi (zona, tipo di stanza, fascia di prezzo, date, ecc.) e le notifiche inviate quando un nuovo annuncio corrisponde. Sono visibili solo a te e non vengono condivisi con altri utenti.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Quando elimini l\'account, profilo, numero di telefono, annunci e foto, notifiche, preferiti, ricerche del Radar annunci e segnalazioni da te inviate vengono eliminati subito e definitivamente.',
