...
export const DISTRICT_COORDINATES_MAP: Record<string, [number, number]> = {
  'Policlinico / Tıp Fakültesi (< 500m)': [45.4032, 11.8886],
  'Portello / Mühendislik & Fen (< 500m)': [45.4085, 11.8920],
  'Beato Pellegrino / Beşeri Bilimler': [45.4146, 11.8719],
  'Centro Storico': [45.4067, 11.8774],
  'Prato della Valle': [45.3984, 11.8758],
...
export const DISTRICT_BENCHMARKS: Record<string, {
  ...
  'Centro Storico': {
    districtLabel: 'Centro Storico',
    marketTrend: 'Tarihi merkez, sosyal hayatın ve Bo Sarayı çevresinin kalbi, her şey yürüme mesafesinde',
  },
  'Prato della Valle': {
    districtLabel: 'Prato della Valle',
    marketTrend: 'Geniş meydan çevresi, tramvay hattı üzerinde ve canlı öğrenci hayatı',
  },
  'Forcellini': {
