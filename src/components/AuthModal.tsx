...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleGoogleAuth = async () => {
    ...
    setAuthError(null);
    try {
      // Supabase OAuth tüm sayfayı sağlayıcıya yönlendirir; başarı sonrası bu satırdan sonrası çalışmaz.
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Supabase, doğrulanmamış e-postayla girişi doğrudan reddeder (Firebase'in aksine);
      // bu durumda hata göstermek yerine doğrulama ekranına yönlendiriyoruz.
